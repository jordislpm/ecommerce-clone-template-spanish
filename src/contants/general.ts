...
export const slidesData: SlideType[] = [
  ...
  {
    id: 2,
    title: "Siente la alegría de la Navidad",
    description: "Ríe, comparte y vístete con estilo. ¡Hasta 50% menos en looks para celebrar! 🎄✨🎅",
    img: "/christmas.jpg",
    url: "/list?cat=🎄dulce-navidad-🎄",
  ...
  {
    id: 3,
    title: "Looks cómodos para todo el año",
    description: "¡Momentos de juego y comodidad! 🧸 Hasta 50% de descuento",
    img: "/spring.jpg",
    url: "/list?cat=conjuntos",
